...
<!DOCTYPE html>
<head>
<title>Added STUDENT Detail's</title>
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th>NAME</th>
            <th>Cource</th>
            <th data-breakpoints="xs"> Year/Sem</th>
...
$qry = "SELECT * from addstudentdata order by id desc ";
...
<td><img src="img/<?php echo $row["image"]; ?>" style='width: 150px;height:150px ;'></td>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2021 RITEE. All rights reserved  </p>
			</div>
		  </div>
  <!-- / footer -->
</section>
